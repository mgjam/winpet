...
{
    public IReadOnlyList<RectangleF> Areas { get; }
    public IReadOnlyList<RectangleF> Obstacles { get; }

    public World(IEnumerable<RectangleF> areas, IEnumerable<RectangleF> obstacles)
    {
